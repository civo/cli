...
func init() {
	...
	rootCmd.PersistentFlags().BoolVarP(&defaultRemove, "yes", "y", false, "Automatic yes to prompts; assume \"yes\" as answer to all prompts and run non-interactively")
