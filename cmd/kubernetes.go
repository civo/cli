...
func init() {
	...
	kubernetesCreateCmd.Flags().StringVarP(&rulesFirewall, "firewall-rules", "u", "", "optional, can be used if the --create-firewall flag is set, semicolon-separated list of ports to open")
