...
func init() {
	...
	kubernetesCreateCmd.Flags().BoolVar(&nodefaultapplications, "no-default-applications", false, "optional, makes all applications 'opt-in' instead of installing default applications")
