...
func init() {
	...
	kubernetesCreateCmd.Flags().BoolVar(&installdefaultapplications, "install-default-applications", true, "set this to false to disable installing default applications")
